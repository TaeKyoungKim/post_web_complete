...
router.get('/content', loggedInOnly , (req, res, next)=>{
  res.render('insert')
})
  
router.post('/content' , loggedInOnly ,async function(req, res){
    ...
    await  queryUtil.create_blog(KEY ,blogNum,title,desc  )
...
router.post('/delete/:id',loggedInOnly,  (req ,res , next)=>{
